...
/**
 *Variables for the fundraising app
*/

$start = 14;  //number of days back to search for names in PayPal
$accounts = 1;  //access a second account (supports 1 or 2)

//manually add $ from non-paypal source - text file name
$addBalanceFile = 'FILENAME.TXT';

//where will transactions.php write list of names - text file name
$namesFile = 'FILENAME.TXT';

//End variables specific to fundraising app

$sandbox = FALSE;
$domain = $sandbox ? 'https://sandbox.example.com/' : 'https://www.example.com/';
...
$application_id2 = $sandbox ? '' : '';
$api_url = $sandbox ? 'beta-sandbox' : 'live';

/**
 * PayPal Developer Account Email Address
 * This is the email address that you use to sign in to http://developer.paypal.com
 */
$developer_account_email = 'EX@EXAMPLE.COM';
$developer_account_email2 = 'EX2@EXAMPLE.COM';
 ...
 */
$api_username = $sandbox ? 'SANDBOX_USER' : 'LIVE_USER';
$api_password = $sandbox ? 'SANDBOX_PASSWORD' : 'LIVE_PASSWORD';
$api_signature = $sandbox ? 'SANDBOX_SIGNATURE' : 'LIVE_SIGNATURE';

//2nd account if needed
$api_username2 = $sandbox ? 'SANDBOX_USER2' : 'LIVE_USER2';
$api_password2 = $sandbox ? 'SANDBOX_PASSWORD2' : 'LIVE_PASSWORD2';
$api_signature2 = $sandbox ? 'SANDBOX_SIGNATURE2' : 'LIVE_SIGNATURE2';
